...
// Vendor copy, byte-identical to upstream except the filterottl import
// below, which points at the local trimmed copy in ../filterottl instead
// of the internal package this module cannot import. See ../NOTICE.md.
...
import (
	...
	"github.com/ucpr/tailsamplingpreviewer/internal/upstreamtsp/filterottl"
)
